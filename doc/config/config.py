...
#done in the specialized conf.py
#sys.path.append(os.path.abspath('config'))

# Add any Sphinx extension module names here, as strings. They can be extensions
# coming with Sphinx (named 'sphinx.ext.*') or your custom ones.
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig', 'RaptorBuilder']
...
project = u'Raptor'
copyright = u'2011, Christophe Duvernois'
...
latex_documents = [
  ('index', 'Raptor.tex', u'Raptor Documentation',
   u'Christophe Duvernois', 'manual'),
]
